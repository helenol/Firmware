...
PARAM_DEFINE_FLOAT(FLOW_S_ACC_BIAS, 0.0006f);
PARAM_DEFINE_FLOAT(FLOW_S_BARO, 0.5f);
PARAM_DEFINE_FLOAT(FLOW_S_BARO_BIAS, 0.005f);
PARAM_DEFINE_FLOAT(FLOW_S_FLOW, 0.3f);
PARAM_DEFINE_FLOAT(FLOW_S_SNR, 0.02f);
PARAM_DEFINE_FLOAT(FLOW_S_POS_NOISE, 0.01f);
PARAM_DEFINE_FLOAT(FLOW_S_VEL_NOISE, 0.01f);
PARAM_DEFINE_FLOAT(FLOW_S_ACC_NOISE, 0.01f);
